...
public class DeleteLoggingConfigOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a DeleteLoggingConfigOptions.
     *
     * @return the new DeleteLoggingConfigOptions instance
     */
     ...
     *
     * @param instanceGuid the instanceGuid
     * @return the DeleteLoggingConfigOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteLoggingConfigOptions builder
   */
