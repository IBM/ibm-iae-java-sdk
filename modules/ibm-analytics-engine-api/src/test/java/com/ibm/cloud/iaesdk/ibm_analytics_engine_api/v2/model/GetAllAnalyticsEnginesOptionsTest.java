...
/**
 * Unit test class for the GetAllAnalyticsEnginesOptions model.
 */
public class GetAllAnalyticsEnginesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAllAnalyticsEnginesOptions() throws Throwable {
    GetAllAnalyticsEnginesOptions getAllAnalyticsEnginesOptionsModel = new GetAllAnalyticsEnginesOptions();
    assertNotNull(getAllAnalyticsEnginesOptionsModel);
  }
}