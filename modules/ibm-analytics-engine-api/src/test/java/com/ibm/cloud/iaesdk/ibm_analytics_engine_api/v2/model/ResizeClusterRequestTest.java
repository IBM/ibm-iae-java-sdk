...
/**
 * Unit test class for the ResizeClusterRequest model.
 */
public class ResizeClusterRequestTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testResizeClusterRequest() throws Throwable {
    ResizeClusterRequest resizeClusterRequestModel = new ResizeClusterRequest();
    assertNotNull(resizeClusterRequestModel);
  }
}