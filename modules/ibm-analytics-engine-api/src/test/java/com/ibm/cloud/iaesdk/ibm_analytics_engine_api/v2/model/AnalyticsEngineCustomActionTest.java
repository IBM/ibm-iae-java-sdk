...
/**
 * Unit test class for the AnalyticsEngineCustomAction model.
 */
public class AnalyticsEngineCustomActionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAnalyticsEngineCustomAction() throws Throwable {
    ...
    AnalyticsEngineCustomAction analyticsEngineCustomActionModelNew = TestUtilities.deserialize(json, AnalyticsEngineCustomAction.class);
    assertTrue(analyticsEngineCustomActionModelNew instanceof AnalyticsEngineCustomAction);
    assertEquals(analyticsEngineCustomActionModelNew.name(), "testString");
