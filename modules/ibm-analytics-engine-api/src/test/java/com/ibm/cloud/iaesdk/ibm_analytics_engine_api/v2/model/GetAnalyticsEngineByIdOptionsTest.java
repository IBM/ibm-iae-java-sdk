...
/**
 * Unit test class for the GetAnalyticsEngineByIdOptions model.
 */
public class GetAnalyticsEngineByIdOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAnalyticsEngineByIdOptions() throws Throwable {
    GetAnalyticsEngineByIdOptions getAnalyticsEngineByIdOptionsModel = new GetAnalyticsEngineByIdOptions.Builder()
      ...
      .build();
    assertEquals(getAnalyticsEngineByIdOptionsModel.instanceGuid(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetAnalyticsEngineByIdOptionsError() throws Throwable {
    new GetAnalyticsEngineByIdOptions.Builder().build();
  }
