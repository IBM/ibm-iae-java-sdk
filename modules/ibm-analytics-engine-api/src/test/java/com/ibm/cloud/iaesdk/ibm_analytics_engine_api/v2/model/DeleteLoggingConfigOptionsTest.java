...
/**
 * Unit test class for the DeleteLoggingConfigOptions model.
 */
public class DeleteLoggingConfigOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteLoggingConfigOptions() throws Throwable {
    DeleteLoggingConfigOptions deleteLoggingConfigOptionsModel = new DeleteLoggingConfigOptions.Builder()
      .instanceGuid("testString")
      .build();
    assertEquals(deleteLoggingConfigOptionsModel.instanceGuid(), "testString");
  }
  
  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteLoggingConfigOptionsError() throws Throwable {
    new DeleteLoggingConfigOptions.Builder().build();
  }
