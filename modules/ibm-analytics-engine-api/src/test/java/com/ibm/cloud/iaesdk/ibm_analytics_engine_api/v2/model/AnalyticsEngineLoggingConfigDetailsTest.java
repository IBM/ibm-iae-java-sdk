...
/**
 * Unit test class for the AnalyticsEngineLoggingConfigDetails model.
 */
public class AnalyticsEngineLoggingConfigDetailsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAnalyticsEngineLoggingConfigDetails() throws Throwable {
    AnalyticsEngineLoggingConfigDetails analyticsEngineLoggingConfigDetailsModel = new AnalyticsEngineLoggingConfigDetails();
    assertNull(analyticsEngineLoggingConfigDetailsModel.getLogSpecs());
    assertNull(analyticsEngineLoggingConfigDetailsModel.getLogServer());
    assertNull(analyticsEngineLoggingConfigDetailsModel.getLogConfigStatus());
  }
}