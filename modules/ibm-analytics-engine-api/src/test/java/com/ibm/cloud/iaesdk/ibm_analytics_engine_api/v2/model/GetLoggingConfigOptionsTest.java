...
/**
 * Unit test class for the GetLoggingConfigOptions model.
 */
public class GetLoggingConfigOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetLoggingConfigOptions() throws Throwable {
    GetLoggingConfigOptions getLoggingConfigOptionsModel = new GetLoggingConfigOptions.Builder()
      .instanceGuid("testString")
      .build();
    assertEquals(getLoggingConfigOptionsModel.instanceGuid(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetLoggingConfigOptionsError() throws Throwable {
    new GetLoggingConfigOptions.Builder().build();
  }
