...
public class GetResourceConsumptionLimitsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetResourceConsumptionLimitsOptions instance.
     *
     * @param getResourceConsumptionLimitsOptions the instance to initialize the Builder with
     */
