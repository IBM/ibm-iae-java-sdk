...
public class GetCurrentResourceConsumptionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetCurrentResourceConsumptionOptions instance.
     *
     * @param getCurrentResourceConsumptionOptions the instance to initialize the Builder with
     */
